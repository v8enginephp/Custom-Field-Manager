...
!function (e) {
    ...
    !function (e) {
        ...
        r.m = e, r.c = t, r.d = function (e, t, o) {
            ...
            if (r.r(o), Object.defineProperty(o, "default", {enumerable: !0, value: e}), 2 & t && "string" != typeof e) for (var n in e) r.d(o, n, function (t) {
                return e[t]
            }.bind(null, n));
            return o
        }, r.n = function (e) {
        ...
        const s = function (e, t = !1) {
            ...
            }, d = e => Object.entries(e).map(([e, t]) => `${b(e)}="${t}"`).join(" "), u = e => Object.entries(e).map(([e, t]) => c(e) && Object.values(f(e, t)).join("")).filter(Boolean).join(" "), f = (e, t) => {
                let r;
                return e = m(e), t && (Array.isArray(t) ? r = q(t.join(" ")) : ("boolean" == typeof t && (t = t.toString()), r = q(t.trim()))), {name: e, value: t = t ? `="${r}"` : ""}
            }, p = e => e.reduce((e, t) => e.concat(Array.isArray(t) ? p(t) : t), []), m = e => ({className: "class"}[e] || b(e)), b = e => (e = (e = e.replace(/[^\w\s\-]/gi, "")).replace(/([A-Z])/g, (function (e) {
                return "-" + e.toLowerCase()
            }))).replace(/\s/g, "-").replace(/^-+/g, ""), h = e => e.replace(/-([a-z])/g, (e, t) => t.toUpperCase()), g = function () {
                let e, t = 0;
                return function (r) {
            ...
            w = function (e, t = "", r = {}) {
                ...
                if (t) {
                    ...
                    for (let t = 0; t < e.length; t++) {
                        const o = v(e[t]), n = e[t].getElementsByTagName("option"), i = e[t].getElementsByTagName("userData");
                ...
                return r
            }, F = (e, t, r) => t.split(" ").forEach(t => e.addEventListener(t, r, !1)), R = (e, t) => {
                const r = t.replace(".", "");
            ...
            }, P = e => e.replace(/\s/g, "-").replace(/[^a-zA-Z0-9[\]_-]/g, ""), M = e => e.replace(/[^0-9]/g, ""), z = (e, t) => t.filter((function (e) {
        ...
        function Q(e) {
            const t = ["a", "an", "and", "as", "at", "but", "by", "for", "for", "from", "in", "into", "near", "nor", "of", "on", "onto", "or", "the", "to", "with"].map(e => `\\s${e}\\s`), r = new RegExp(`(?!${t.join("|")})\\w\\S*`, "g");
 ...
 */
        e.exports = function (e) {
            ...
            var o = r(0), n = r(14), i = r(16), l = r(17), a = r(18), s = r(4), c = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || r(19);
            e.exports = function (e) {
                return new Promise((function (t, d) {
                    ...
                    if (p.open(e.method.toUpperCase(), i(e.url, e.params, e.paramsSerializer), !0), p.timeout = e.timeout, p[m] = function () {
                        ...
                        var y = r(20), w = (e.withCredentials || a(e.url)) && e.xsrfCookieName ? y.read(e.xsrfCookieName) : void 0;
            ...
            var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            }(), i = r(8), l = {extension: ".lang", location: "assets/lang/", langs: ["en-US"], locale: "en-US", override: {}}, a = t.I18N = function () {
                function e() {
                ...
                return e.prototype.processConfig = function (e) {
                    ...
                    var a = this.config, s = a.override, c = a.preloaded, d = void 0 === c ? {} : c, u = Object.entries(this.langs).concat(Object.entries(s || d));
                    ...
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = this.config.override[e] || {}, o = this.langs[e] || {};
 ...
 */
        ...
        const i = {
            ...
            typeUserEvents: {}
        }, l = {btn: ["default", "danger", "info", "primary", "success", "warning"]}, a = {location: "assets/lang/"}, s = {}
    }, function (e, t, r) {
        r.d(t, "d", (function () {
            return o
        })), r.d(t, "f", (function () {
        ...
        const o = {}, n = {text: ["text", "password", "email", "color", "tel"], header: ["h1", "h2", "h3"], button: ["button", "submit", "reset"], paragraph: ["p", "address", "blockquote", "canvas", "output"], textarea: ["textarea", "quill"]}, i = e => {
            ...
            return o
        }, s = ["select", "checkbox-group", "checkbox", "radio-group", "autocomplete"], c = new RegExp(`(${s.join("|")})`);
        ...
        class l extends o.a {
            ...
            build() {
                ...
                const t = Object.assign(this.config), r = ["label", "description", "subtype", "id", "isPreview", "required", "title", "aria-required", "type"];
                ...
                return this.map((function (t) {
                    var r = function (e, t) {
                        ...
                        if (t && "function" == typeof btoa) {
                            var n = (l = o, a = btoa(unescape(encodeURIComponent(JSON.stringify(l)))), s = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a), "/*# ".concat(s, " */")), i = o.sources.map((function (e) {
        ...
        function s(e, t) {
            for (var r = {}, o = [], n = 0; n < e.length; n++) {
                var i = e[n], s = t.base ? i[0] + t.base : i[0], c = r[s] || 0, d = "".concat(s, " ").concat(c);
                r[s] = c + 1;
                var u = a(d), f = {css: i[1], media: i[2], sourceMap: i[3]};
        ...
        class i {
            ...
            label() {
                const e = this.data.label || "", t = [o.f.parsedHtml(e)];
        ...
        class a extends n.a {
            ...
            build() {
                const e = this.config, {values: t, type: r} = e, o = l(e, ["values", "type"]), n = e => {
                    ...
                    focus: e => {
                        const t = e.target.nextSibling.nextSibling, r = Object(i.c)(t.querySelectorAll("li"), e.target.value);
                ...
                }, s = Object.assign({}, o, {id: o.id + "-input", autocomplete: "off", events: a}), c = Object.assign({}, o, {type: "hidden"});
                delete s.name;
                const d = [this.markup("input", null, s), this.markup("input", null, c)], u = t.map(e => {
                    const t = e.label, r = {
                        events: {
                            click: t => {
        ...
        class b extends n.a {
            ...
            build() {
                const e = [], t = this.config, {values: r, value: o, placeholder: n, type: i, inline: l, other: a, toggle: s} = t, c = m(t, ["values", "value", "placeholder", "type", "inline", "other", "toggle"]), d = i.replace("-group", ""),
                    f = "select" === i;
                if ((c.multiple || "checkbox-group" === i) && (c.name = c.name + "[]"), "checkbox-group" === i && c.required && (this.onRender = this.groupRequired), delete c.title, r) {
                    ...
                    for (let t = 0; t < r.length; t++) {
                        ...
                        if (u.id = `${c.id}-${t}`, u.selected && !n || delete u.selected, void 0 !== o && u.value === o && (u.selected = !0), f) {
                            ...
                            const o = this.markup("input", null, Object.assign({}, c, u)), n = {for: u.id};
                    ...
                    if (!f && a) {
                        ...
                        }, i = this.markup("input", null, o), a = [document.createTextNode("Other"), this.markup("input", null, n)], s = this.markup("label", a, {for: o.id}), u = this.markup("div", [i, s], {className: r});
                        e.push(u)
                    }
                }
            ...
            onRender() {
                const t = e(this.wrapper), r = e(this.input), o = jQuery.extend(!0, {
                    ...
                    callbacks: {
                        onError: (r, o, n) => {
                            "." != n.slice(-1) && (n += ".");
                            const i = e("<div />").addClass("qq-error-message").html(`<span>Error processing upload: <b>${o}</b>.<br />Reason: ${n}</span>`).prependTo(t.find(".qq-uploader")), l = window.setTimeout(() => {
                                i.fadeOut(() => {
        ...
        class q extends w {
            configure() {
                const e = {modules: {toolbar: [[{header: [1, 2, !1]}], ["bold", "italic", "underline"], ["code-block"]]}, placeholder: this.config.placeholder || "", theme: "snow"}, [t, r] = u.f.splitObject(this.classConfig, ["css", "js"]);
            ...
            build() {
                const e = this.config, {value: t = ""} = e, r = O(e, ["value"]);
        ...
        var o = r(20), n = "object" == typeof self && self && self.Object === Object && self, i = o || n || Function("return this")();
        e.exports = i
    }, function (e, t, r) {
        var o = r(13).Symbol;
        e.exports = o
        ...
        e.exports = function (e, t, r) {
            var s, c, d, u, f, p, m = 0, b = !1, h = !1, g = !0;
            if ("function" != typeof e) throw new TypeError("Expected a function");
        ...
        var o = r(23), n = r(11), i = r(25), l = /^[-+]0x[0-9a-f]+$/i, a = /^0b[01]+$/i, s = /^0o[0-7]+$/i, c = parseInt;
        e.exports = function (e) {
        ...
        var c = o(2), d = o.n(c), u = o(5), f = o(10), p = o(0), m = o(3), b = o(1), h = o(6);
        ...
        class y {
            ...
            fieldOptionData(t) {
                ...
                return o.each(e => {
                    const t = o[e], n = t.querySelectorAll("input[type=text], input[type=number], select"), i = t.querySelectorAll("input[type=checkbox], input[type=radio]"), l = {};
                    Object(p.i)(n, e => {
            ...
            prepData(t) {
                ...
                return 0 !== t.childNodes.length && Object(p.i)(t.childNodes, (function (t, i) {
                    ...
                    if (!l.hasClass("disabled-field")) {
                        let t = n.getTypes(l);
                        const a = e(".roles-field:checked", i), s = a.map(e => a[e].value).get();
                        if (t = Object.assign({}, t, n.getAttrVals(i)), t.subtype) if ("quill" === t.subtype) {
            ...
            save(e) {
                const t = this, r = this.data, o = this.d.stage, n = {xml: e => t.xmlSave(o, e), json: e => window.JSON.stringify(t.prepData(o), null, e && "  ")};
            ...
            getAttrVals(t) {
                ...
                return Object(p.i)(o, t => {
                    const n = o[t], i = Object(p.c)(n.getAttribute("name")),
            ...
            updatePreview(t) {
                ...
                const c = h.a.lookup(s.type), d = c ? c.class : b.a.getClass(s.type, s.subtype), f = this.layout.build(d, s);
            ...
            disabledTT(e) {
                ...
                Object(p.i)(t, e => {
                    const r = t[e], o = d.a.get("fieldNonEditable");
                    if (o) {
                        const e = Object(p.q)("p", o, {className: "frmb-tt"});
                        r.appendChild(e), r.addEventListener("mousemove", t => ((e, t) => {
                            const r = t.field.getBoundingClientRect(), o = e.clientX - r.left - 21, n = e.clientY - r.top - t.tt.offsetHeight - 12;
            ...
            confirm(e, t, r = !1, o = "") {
                const n = this, i = d.a.current, l = n.showOverlay(), a = Object(p.q)("button", i.yes, {className: "yes btn btn-success btn-sm"}), s = Object(p.q)("button", i.no, {className: "no btn btn-danger btn-sm"});
                s.onclick = function () {
                    n.closeConfirm(l)
                }, a.onclick = function () {
                    t(), n.closeConfirm(l)
            ...
            confirmRemoveAll(t) {
                const r = this, o = t.target.id.match(/frmb-\d{13}/)[0], n = document.getElementById(o), i = d.a.current, l = e("li.form-field", n), a = t.target.getBoundingClientRect(), s = document.body.getBoundingClientRect(),
            ...
            removeAllFields(e) {
                const t = d.a.current, r = m.a.opts, o = [];
            ...
            closeAllEdit() {
                const t = e("> li.editing", this.d.stage), r = e(".toggle-form", this.d.stage), o = e(".frm-holder", t);
            ...
            stickyControls() {
                ...
                e(window).scroll((function (l) {
                    const a = e(l.target).scrollTop(), s = {top: 5, bottom: "auto", right: "auto", left: n.left}, c = Object.assign({}, s, m.a.opts.stickyControls.offset);
                    if (a > i) {
                        const e = {position: "sticky"}, n = Object.assign(e, c), i = t.getBoundingClientRect(), l = r.getBoundingClientRect(), s = i.top + i.height, d = l.top + l.height, u = s === d && i.top > a;
            ...
            processSubtypes(e) {
                ...
                const r = b.a.getRegisteredSubtypes(), o = Object.entries(r).reduce((e, [r, o]) => (e[r] = t[r] && Object(p.y)(t[r], o) || o, e), {}), n = {};
            ...
            editorUI(e) {
                ...
                t.editorWrap = Object(p.q)("div", null, {id: r.formID + "-form-wrap", className: "form-wrap form-builder " + Object(p.r)()}), t.stage = Object(p.q)("ul", null, {
                    id: o,
            ...
            processOptions(e) {
                ...
                const l = [{type: "button", id: "clear", className: "clear-all btn btn-danger", events: {click: t.confirmRemoveAll.bind(t)}}, {
                    type: "button",
                    label: "viewJSON",
                    id: "data",
        ...
        const k = function (e, t, r) {
            const o = this, n = d.a.current, a = "frmb-" + (new Date).getTime(), c = new s(a), b = new l.a(a);
            e.layout || (e.layout = f.a);
            const h = new e.layout(e.layoutTemplates, !0), g = new y(a, h, o), O = p.q;
            e = g.processOptions(e), c.layout = g.editorLayout(e.controlPosition), g.editorUI(a), c.formID = a, c.lastID = c.formID + "-fld-0";
            const j = new v(e, b), k = m.a.subtypes = g.processSubtypes(e.subtypes), q = r(b.stage), C = r(b.controls);
            q.sortable({
                cursor: "move",
                opacity: .9,
                revert: 150,
            ...
            const E = t => {
                if (t[0].classList.contains("input-set-control")) {
                    const r = [], o = e.inputSets.find(e => Object(p.n)(e.name || e.label) === t[0].dataset.type);
                    if (o && o.showHeader) {
            ...
            }, N = r(b.editorWrap), S = O("div", b.controls, {id: c.formID + "-cb-wrap", className: "cb-wrap " + c.layout.controls});
            ...
            const D = function (t) {
                (t = g.getData(t)) && t.length ? (t.forEach(e => L(Object(p.A)(e))), b.stage.classList.remove("empty")) : e.defaultFields && e.defaultFields.length ? g.addDefaultFields() : e.prepend || e.append || (b.stage.classList.add("empty"), b.stage.dataset.content = d.a.get("getStarted")), (() => {
                    const t = [], o = t => O("li", e[t], {className: "disabled-field form-" + t});
                ...
                const {type: r} = t, o = [], n = j.getClass(r), i = (e => {
                    const t = ["required", "label", "description", "placeholder", "className", "name", "access", "value"], r = !["header", "paragraph", "file", "autocomplete"].concat(b.optionFields).includes(e), o = {
                    ...
                    access: () => {
                        ...
                        for (a in e.roles) if (e.roles.hasOwnProperty(a)) {
                            const t = `fld-${c.lastID}-roles-${a}`, o = {type: "checkbox", name: "roles[]", value: a, id: t, className: "roles-field"};
                    ...
                    options: () => function (e) {
                        ...
                        let o;
                        const n = [O("a", d.a.get("addOption"), {className: "add add-opt"})], i = [O("label", d.a.get("selectOptions"), {className: "false-label"})], l = e.multiple || "checkbox-group" === t, a = e => {
                        ...
                        const s = O("div", n, {className: "option-actions"}), c = O("ol", o.map((e, r) => {
                            const o = m.a.opts.onAddOption(e, {type: t, index: r, isMultiple: l});
                            return Y(o, l)
                        }), {className: "sortable-options"}), u = O("div", [c, s], {className: "sortable-options-wrap"});
                    ...
                    multiple: () => {
                        const e = {default: {first: "Multiple", second: "set multiple attribute"}, file: {first: d.a.get("multipleFiles"), second: d.a.get("allowMultipleFiles")}, select: {first: " ", second: d.a.get("selectionsMessage")}};
                ...
                if (Object.keys(i).forEach(t => {
                    const a = i[t], s = [!0], c = e.disabledAttrs.includes(a);
            ...
            function R(e, t) {
                const r = [], o = {
                    array: P, string: I, number: U, boolean: (e, r) => {
                        let o = !1;
                        return "checkbox" === e.type ? o = Boolean(!!r.hasOwnProperty("value") && r.value) : t.hasOwnProperty(e) ? o = t[e] : (r.hasOwnProperty("value") || r.hasOwnProperty("checked")) && (o = r.value || r.checked || !1), M(e, A(A({}, r), {}, {[e]: o}), {first: r.label})
                    }
                };
                for (const i in e) if (e.hasOwnProperty(i)) {
                    const l = B(e[i]);
                    if ("undefined" !== l) {
                        const a = d.a.get(i), s = e[i], c = s.value || "";
            ...
            function P(e, t) {
                const {multiple: r, options: o, label: i, value: l, class: a, className: s} = t, u = x(t, ["multiple", "options", "label", "value", "class", "className"]), f = Object.keys(o).map(e => {
                    const t = {value: e}, r = o[e], n = Array.isArray(r) ? d.a.get(...r) || r[0] : r;
            ...
            const M = (e, t, r = {}) => {
                const o = t => O("label", t, {for: `${e}-${c.lastID}`}).outerHTML, n = {type: "checkbox", className: "fld-" + e, name: e, id: `${e}-${c.lastID}`};
                t[e] && (n.checked = !0);
                const i = [];
                let l = [O("input", null, n).outerHTML];
                return r.first && i.push(o(r.first)), r.second && l.push(" ", o(r.second)), r.content && l.push(r.content), l = O("div", l, {className: "input-wrap"}).outerHTML, O("div", i.concat(l), {className: `form-group ${e}-wrap`}).outerHTML
            }, z = e => {
                let t = "";
                "undefined" === e && (e = "default");
                const r = `<label>${n.style}</label>`;
                return t += g.input({value: e || "default", type: "hidden", className: "btn-style"}).outerHTML, t += '<div class="btn-group" role="group">', m.d.btn.forEach(r => {
                    const o = ["btn-xs", "btn", "btn-" + r];
                    e === r && o.push("selected");
                    const n = O("button", d.a.get("styles.btn." + r), {value: r, type: "button", className: o.join(" ")}).outerHTML;
                    t += n
                }), t += "</div>", t = O("div", [r, t], {className: "form-group style-wrap"}), t.outerHTML
            }, U = (e, t) => {
                const {class: r, className: o, value: n} = t, i = x(t, ["class", "className", "value"])[e] || n, l = d.a.get(e) || e,
                    a = {type: "number", value: i, name: e, placeholder: d.a.get("placeholder." + e), className: `fld-${e} form-control ${r || o || ""}`.trim(), id: `${e}-${c.lastID}`}, s = g.input(Object(p.A)(a)).outerHTML;
                ...
                }), i = {id: e + "-" + c.lastID, name: e, className: `fld-${e} form-control`}, l = d.a.get(e) || Object(p.d)(e) || "", a = O("label", l, {for: i.id}), s = O("select", o, i), u = O("div", s, {className: "input-wrap"});
                return O("div", [a, u], {className: `form-group ${i.name}-wrap`}).outerHTML
            }, Q = (t, r, o = !1) => {
                const n = ["paragraph"];
                let i = r[t] || "", l = d.a.get(t);
                "label" === t && (n.includes(r.type) ? l = d.a.get("content") : i = Object(p.u)(i));
                const a = d.a.get("placeholders." + t) || "";
                let s = "";
                if (![].some(e => !0 === e)) {
                    const n = {name: t, placeholder: a, className: `fld-${t} form-control`, id: `${t}-${c.lastID}`}, d = O("label", l, {for: n.id}).outerHTML;
                ...
                let u = [O("a", null, {type: "remove", id: "del_" + c.lastID, className: `del-button btn ${w.a}cancel delete-confirm`, title: d.a.get("removeMessage")}), O("a", null, {
                    type: "edit",
                    id: c.lastID + "-edit",
                ...
                const h = O("div", [T(t), O("a", d.a.get("close"), {className: "close-field"})], {className: "form-elements"}), y = O("div", h, {id: c.lastID + "-holder", className: "frm-holder", dataFieldId: c.lastID});
                o.currentEditPanel = y, f.push(y);
                const v = O("li", f, {class: l + "-field form-field", type: l, id: c.lastID}), x = r(v);
                x.data("fieldData", {attrs: t}), void 0 !== g.stopIndex ? r("> li", b.stage).eq(g.stopIndex).before(x) : q.append(x), r(".sortable-options", x).sortable({update: () => g.updatePreview(x)}), g.updatePreview(x), e.typeUserEvents[l] && e.typeUserEvents[l].onadd && e.typeUserEvents[l].onadd(v), i && (e.editOnAdd && (g.closeAllEdit(), g.toggleEdit(c.lastID, !1)), v.scrollIntoView && e.scrollToFieldOnAdd && v.scrollIntoView({behavior: "smooth"}))
            }, Y = function (e, t) {
                ...
                const n = Object.entries(e).map(([e, t]) => {
                    const r = Object(p.k)(t), [n, i, l] = o[r](t, e), a = `option-${e} option-attr`;
            ...
            }, 333, {leading: !1})), q.on("click touchstart", ".remove", t => {
                const o = r(t.target).parents(".form-field:eq(0)"), n = o[0], i = n.getAttribute("type"), l = r(t.target.parentElement);
                t.preventDefault();
            ...
            if (q.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), e => {
            ...
            }), q.on("keyup", "input.error", ({target: e}) => r(e).removeClass("error")), q.on("keyup", 'input[name="description"]', (function (e) {
                ...
                const t = e.target.checked ? "checkbox" : "radio", o = r(".option-selected", r(e.target).closest(".form-elements"));
                ...
                t.preventDefault();
                const o = t.target.getBoundingClientRect(), n = document.body.getBoundingClientRect(), i = {pageX: o.left + o.width / 2, pageY: o.top - n.top - 12}, l = r(t.target).parents(".form-field:eq(0)").attr("id"),
                    a = r(document.getElementById(l));
                if (document.addEventListener("modalClosed", (function () {
                    a.removeClass("deleting")
                }), !1), e.fieldRemoveWarn) {
                    const e = O("h3", d.a.get("warning")), t = O("p", d.a.get("fieldRemoveWarning"));
                ...
                e.preventDefault();
                const t = r(e.target).closest(".form-field").attr("type"), o = r(e.target).closest(".field-options"), n = r('[name="multiple"]', o), i = r(".option-selected:eq(0)", o);
                let l = !1;
                l = n.length ? n.prop("checked") : "checkbox" === i.attr("type");
                const a = r(".sortable-options", o), s = m.a.opts.onAddOption({selected: !1, label: "", value: ""}, {type: t, index: a.children().length, isMultiple: l});
                a.append(Y(s, l))
            ...
            return document.dispatchEvent(u.a.loaded), o.actions = {
                getFieldTypes: t => t ? Object(p.y)(j.getRegistered(), e.disableFields) : j.getRegistered(), clearFields: e => g.removeAllFields(b.stage, e), showData: g.showData.bind(g), save: e => {
                    const t = g.save(e), r = window.JSON.parse(t);
                    return m.a.opts.onSave(r), r
                }, addField: (e, t) => {
                    g.stopIndex = c.formData.length ? t : void 0, L(e)
                }, removeField: g.removeField.bind(g), getData: g.getFormData.bind(g), setData: e => {
                ...
                }, showDialog: g.dialog.bind(g), toggleFieldEdit: e => {
                ...
                }, closeAllFieldEdit: g.closeAllEdit.bind(g), getCurrentFieldId: () => c.lastID
            ...
            init: (e, t) => {
                const r = jQuery.extend({}, m.c, e, !0), {i18n: o} = r, n = x(r, ["i18n"]);
                m.a.opts = n;
